...
| [ADR-003](ADR-003-datalog-lattice-traversal.md) | Datalog (pg_mentat) for lattice traversal over recursive CTEs | Accepted |
| [ADR-004](ADR-004-fides-product-lattice-authority.md) | FIDES two-element product lattice as authority substrate | Accepted |
